...
- isolatedProcess framing was imprecise
- Left out Chromium's V8 sandbox, Oilpan, CFI, MTE
- Didn't catch SpiderMonkey's missing CFI
- Wrongly claimed hardware mitigations are automatic
- Poor CVE count framing
- Implied Firefox extensions have better site isolation properties
...
- Browser choice is a threat-model alignment
